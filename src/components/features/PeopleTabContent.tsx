                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-9 pr-4 py-2 bg-muted/50 border border-transparent focus:bg-background focus:border-primary rounded-lg text-sm w-full md:w-64 transition-all outline-none"
                            />
                        </div>

                        {/* Invite Button (Teacher Only) */}
