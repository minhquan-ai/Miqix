                ...
                <div className="flex items-center gap-3">
                    <div className="relative group flex-1 sm:w-64">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 placeholder:text-gray-400 transition-all font-medium shadow-sm"
                        />
                        {searchQuery && (
                            <button
